 ...
 * 
 * Compile: javac -cp
 * ".;lib/mysql-connector-j-8.3.0/mysql-connector-j-8.3.0.jar"
 * samples/java/MySQLTest.java
 * Run: java -cp
 * ".;lib/mysql-connector-j-8.3.0/mysql-connector-j-8.3.0.jar;samples/java"
 * MySQLTest
 */
